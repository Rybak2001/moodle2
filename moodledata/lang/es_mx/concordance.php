...
/**
 * Strings for component 'concordance', language 'es_mx', version '3.11'.
 *
 * @package     concordance
 * @category    string
...
$string['configpanelistssystemrole'] = 'A los panelistas se les dará este rol en el contexto del sistema. Usted puede elegir no asignar rol en el sistema para el panelista.';
...
$string['nosystemrole'] = 'Sin rol del sistema.';
...
$string['panelistssystemrole'] = 'Rol del sistema para los panelistas';
