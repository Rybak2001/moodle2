...
/**
 * Strings for component 'customlabeltype_coursedata', language 'es_mx', version '3.11'.
 *
...
$string['concepts'] = 'Conceptos clave';
$string['configtypename'] = 'Habilitar subtipo Información del Curso';
...
$string['showgoals'] = 'Mostrar Metas';
$string['showlearningmethod'] = 'Mostrar Método de aprendizaje';
$string['showobjectives'] = 'Mostrar objetivos del alumn';
$string['showprerequisites'] = 'Mostrar prerequisitos';
$string['showtarget'] = 'Mostrar destino';
