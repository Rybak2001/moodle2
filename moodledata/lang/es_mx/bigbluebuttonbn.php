...
/**
 * Strings for component 'bigbluebuttonbn', language 'es_mx', version '3.11'.
 *
...
$string['bigbluebuttonbn:view'] = 'Ver una sala BigBlueButton';
...
$string['completionattendance_desc'] = 'Ingresar a la sala y permanecer en la sesión por al menos {$a} minuto(s)';
...
$string['completionengagementemojis_event_desc'] = 'Cambiado {$a} veces su(s) emoji(s)';
...
$string['completionengagementraisehand'] = 'Requerir mano levantada';
...
$string['config_checksum_algorithm'] = 'Algoritmo de suma de verificación de BigBlueButton';
$string['config_checksum_algorithm_description'] = 'El algoritmo de suma de verificación de su servidor BigBlueButton.
(SHA1 garantiza compatibilidad con versiones antiguas del servidor, pero es menos seguro, mientras que SHA512 es compatible con FIPS 140-2.)';
...
$string['config_lockonjoin_default_description'] = 'Si se habilita, las configuraciones bloqueadas por configuración serán aplicadas al usuario cuando se unan.  La configuración del bloqueo debe estar habilitada para que esto aplique.';
$string['config_lockonjoin_editable'] = 'Bloqueo al unirse puede ser editado';
$string['config_lockonjoin_editable_description'] = 'La configuración predterminada de bloquear al unirse puede ser editado cuando la instancia es añadida o actualizada.';
...
$string['config_meetingevents_enabled'] = 'Registrar sesiones en vivo';
...
$string['config_presentation_default'] = 'Archivo predeterminado de presentación';
...
$string['config_preuploadpresentation'] = 'Pre-cargar presentación';
...
$string['config_recordings_sortorder_description'] = 'Por defecto las grabaciones son mostradas en orden descendente. Cuando se activa serán ordenadas en orden ascendente.';
...
$string['config_waitformoderator_editable'] = 'Esperar a un moderador puede ser editada';
...
$string['email_body_recording_ready_for'] = 'Hay una grabación lista por';
$string['email_body_recording_ready_in_course'] = 'en el curso';
...
$string['index_error_checksum'] = 'Hubo un error de la suma de comprobación. Asegúrese de haber ingresado a la sala correcta.';
$string['index_error_forciblyended'] = 'No se pudo ingresar a esta sesión debido a que fue terminada manualmente.';
$string['index_error_noinstances'] = 'No hay instancias de salas de BigBlueButton';
...
$string['taskname:check_dismissed_recordings'] = 'Comprobar si hay grabaciones descartadas';
...
$string['view_message_conference_user_limit_reached'] = 'El número de usuarios permitidos en una sesión ha sido alcanzado';
