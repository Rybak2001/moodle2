...
/**
 * Strings for component 'tool_ally', language 'es_mx', version '3.11'.
 *
 * @package     tool_ally
 * @category    string
...
$string['cachedef_fileinusecache'] = 'Archivos Ally en caché en uso';
$string['cachedef_pluginfilesinhtml'] = 'Archivos Ally en caché HTML';
...
$string['deferredcourseevents'] = 'Enviar eventos diferidos del curso';
$string['deferredcourseeventsdesc'] = 'Permitir el envío de eventos almacenados del curso, que fueron acumulados durante ffa en la comunicación con Ally';
...
$string['excludeunused'] = 'Excluir archivos no usados';
$string['excludeunuseddesc'] = 'Omitir archivos que estén anexos a contenido HTML, pero enlazados/referenciados en el HTML.';
...
$string['level'] = 'Nivel';
$string['logcleanuptask'] = 'Trabajo de limpieza de bitácora de Ally';
...
$string['loglifetimedays'] = 'Mantener bitácoras por estos días';
$string['loglifetimedaysdesc'] = 'Retener las bitácoras de Ally por estos días. Configurar a 0 para nunca eliminar bitácoras. Un trabajo agendado es (de forma predeterminada) configurado a ejecutarse diariamente, y removerá las entradas de bitácora que tengan más de estos días de antiguedad.';
