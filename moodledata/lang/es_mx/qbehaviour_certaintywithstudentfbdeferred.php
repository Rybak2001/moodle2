...
/**
 * Strings for component 'qbehaviour_certaintywithstudentfbdeferred', language 'es_mx', version '3.11'.
 *
...
$string['allegederror'] = 'Errores posibles';
$string['allegederror_details'] = 'Error posible ({$a})';
$string['almostsure'] = 'Casi seguro';
$string['almostsure_details'] = 'casi seguro';
$string['answer'] = 'su respuesta fue {$a}';
$string['answercategorydetails'] = 'usted tuvo {$a->certainty} y {$a->youranswer}';
$string['behavioursummary'] = 'Resumen de certidumbre';
$string['correct'] = 'correcto';
$string['correctanswers'] = 'Respuestas correctas';
$string['declaredignorance'] = 'Ignorancia declarada';
$string['declaredignorance_details'] = 'La ignorancia declarada (usted contestó aleatoriamente, el que su respuesta fuese correcta o incorrecta no importa)';
...
$string['ndeclaredignorance'] = 'Ignorancia declarada: {$a}';
