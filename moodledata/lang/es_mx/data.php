...
/**
 * Strings for component 'data', language 'es_mx', version '3.11'.
 *
 * @package     data
 * @category    string
...
$string['missingfieldtypes'] = 'Los campos siguientes no tienen sus tipos de campo correspondientes instalados y no serán incluidos en los formatos cuando se añadan o editen entradas.
Sus etiquetas podrían seguir mostrando el formato, por lo que por favor se le pide que actualice apropiadamente el "Añadir plantilla de entrada":';
...
$string['uploadrecords_help'] = 'Las entradas pueden ser subidas a través de un archivo de texto. El formato del archivo debe ser el siguiente:

* Cada línea del archivo contiene un registro
* Cada registro contiene una serie de datos separados por el separador seleccionado
* El primer registro contiene una lista de nombres de campos (en idioma inglés) que definen el formato del resto del archivo.

El campo delimitador es un caracter que rodea cada campo en cada registro. Normalmente se puede dejar sin configurar.';
