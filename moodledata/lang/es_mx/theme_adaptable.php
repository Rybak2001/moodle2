...
$string['courseadditionalmoddatamaxstudentsdesc'] = 'Información adicional puede tomar tiempo para calcularla, especialmente en cursos grandes, por lo que aquí puede configurar el número máximo de estudiantes que puede tener un curso para que lo muestre la funcionalidad en ese curso. ¡Arriba de este valor, la \'Información adicional\' NO SERÁ calculada ni mostrada sin importar las configuraciones del curso! Un valor de \'0\' significa \'ilimitada\'. Nota: Purga las cachés cuando se cambia.';
$string['courseadditionalmoddatastudentsinfolimitednoshow'] = 'Información adicional NO se mostrará para las actividades habilitadas para {$a->students} estudiantes porque el número excede el máximo  \'{$a->maxstudents}\' configurado por el administrador en la configuración \'courseadditionalmoddatamaxstudents\' del tema Adaptable.';
$string['courseadditionalmoddatastudentsinfolimitedshow'] = 'Información adicional se mostrará para las actividades habilitadas para {$a->students} estudiantes porque el número no excede el máximo  \'{$a->maxstudents}\' configurado por el administrador en la configuración \'courseadditionalmoddatamaxstudents\' del tema Adaptable.';
...
$string['deprecated'] = 'VERSIÓN DE MOODLE DEPRECADA. NO USE ADAPTABLE EN ESTE SITIO';
...
$string['enableadditionalmoddatadesc'] = 'Este es un interruptor de \'Nivel del sitio\' para activar y desactivar la información de actividad. Necesita estar \'encendida\' para que tengan efecto las configuraciones relacionadas que operan a nivel del curso. Como esta funcionalidad puede ser computacionalmente costosa, entonces es fuertemente sugerido que usted haga pruebas completas antes de usarla en un sitio de producción. Nota: Purga las cachés cuando es cambiada.';
...
$string['jssectionrestricteddesc'] = 'Añadir código JavaScript al sitio basado condicionalmente en un campo personalizado del perfil . Este JavaScript solamente aparecerá si se cumple esta condición.';
...
$string['newmenu1trigger'] = 'Palabra clave 1 para el Menú desplegable superior';
$string['newmenu1triggerdesc'] = 'Establece palabra clave 1 para el Menú desplegable superior. Se pueden utilizar los iconos de Font Awesome';
$string['newmenu2trigger'] = 'Palabra clave 2 para el Menú desplegable superior';
$string['newmenu2triggerdesc'] = 'Establece la palabra clave 2 para el Menú desplegable superior. Se pueden utilizar los iconos de Font Awesome';
