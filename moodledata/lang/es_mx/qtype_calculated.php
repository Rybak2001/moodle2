...
/**
 * Strings for component 'qtype_calculated', language 'es_mx', version '3.11'.
 *
...
$string['calclength'] = 'Posiciones Decimales';
...
$string['reuseifpossible'] = 're-utilizar el valor previo si estuviera disponible';
