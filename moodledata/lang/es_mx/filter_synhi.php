...
/**
 * Strings for component 'filter_synhi', language 'es_mx', version '3.11'.
 *
...
$string['generalinformation'] = 'El símbolo \'<\' y  el símbolo \'>\' parecer ser problemáticos dentro de una marca (tag) \'pre\', cámbielos a \'<i>(amphersand)</i>lt;\' y \'<i>(amphersand)</i>gt;\' respectivamente para su código - aquí <i>(amphersand)</i> significa \'&\'.';
