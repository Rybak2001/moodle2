...
/**
 * Strings for component 'completion', language 'es_mx', version '3.11'.
 *
 * @package     completion
 * @category    string
...
$string['completionexpected_help'] = 'Esta opción especifica la fecha en que se espera que la actividad esté finalizada. Cuando la fecha se aproxime, la actividad es listada en el bloque de Línea de tiempo en el Tablero.';
