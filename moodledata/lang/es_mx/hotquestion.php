...
/**
 * Strings for component 'hotquestion', language 'es_mx', version '3.11'.
 *
 * @package     hotquestion
 * @category    string
...
$string['ago'] = '{$a} atrás';
$string['allowanonymouspost'] = 'Permitir publicar pregunta anónimamente';
$string['allowanonymouspost_descr'] = 'Si se habilita, se pueden publicar preguntas anónimamente; y si se aprueba que se vean, los votos de calor pueden ser hechos por todos.';
$string['allowanonymouspost_help'] = 'Si se habilita, las preguntas pueden ser publicadas anónimamente, y si se aprueban para ver, los votos de popularidad pueden ser hechos por todos.';
...
$string['inputquestion_descr'] = 'Cambiar instrucciones del envío a lo que Usted quiera que sean.';
$string['inputquestion_help'] = 'Cambiar las instrucciones de envío a lo que Usted quiere que sean.';
...
$string['noquestions'] = 'Todavía no hay entradas.';
...
$string['privacy:metadata:hotquestion_questions:hotquestion'] = 'La ID de la actividad Pregunta Caliente en la cual fue publicado el contenido.';
