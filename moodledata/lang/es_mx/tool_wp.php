...
/**
 * Strings for component 'tool_wp', language 'es_mx', version '3.11'.
 *
 * @package     tool_wp
 * @category    string
...
$string['entitycertificateissues'] = 'Emisión de certificado';
...
$string['exportcoursecontent'] = 'Estructura del curso';
...
$string['exportimportuserspicture'] = 'Imágenes de usuario';
...
$string['importconflictcreatecourse'] = 'Crear curso vacío';
$string['importconflictincategory'] = 'en categoría';
...
$string['importformat'] = 'Formato del archivo';
...
$string['importlogexception'] = 'Exceción: {$a}';
$string['importoptions'] = 'Opciones';
$string['importproblem'] = 'Problema: {$a}';
$string['importproblemaffects'] = 'Afecta:';
...
$string['reg_wpactiveusers'] = 'Número de usuarios únicos que ingresaron el mes pasado ({$a})';
$string['reg_wpparticipantnumberaverage'] = 'Número promedio de participantes activos el mes pasado ({$a})';
$string['reg_wpplugins'] = 'Lista de plugins instalados y habilitados, número de instancias ({$a})';
