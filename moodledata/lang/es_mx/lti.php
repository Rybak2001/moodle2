...
/**
 * Strings for component 'lti', language 'es_mx', version '3.11'.
 *
 * @package     lti
 * @category    string
...
$string['display_description_help'] = 'Si se selecciona, la descripción de la actividad (especificada arriba) se mostrará sobre el contenido del proveedor de la herramienta.
...
$string['display_name_help'] = 'Si se selecciona, el nombre de la actividad (especificado arriba) se mostrará sobre el contenido del proveedor de la herramienta.

Es posible que el proveedor de la herramienta muestre además el título. Esta opción podría evitar que el título de la actividad se mostrara dos veces.
