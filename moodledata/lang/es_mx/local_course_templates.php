...
/**
 * Strings for component 'local_course_templates', language 'es_mx', version '3.11'.
 *
...
$string['inputinfo'] = 'Por favor ingrese la información debajo';
$string['inputinfotip'] = 'Por favor ingrese la información del curso nuevo';
