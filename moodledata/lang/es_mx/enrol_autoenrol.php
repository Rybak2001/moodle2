...
/**
 * Strings for component 'enrol_autoenrol', language 'es_mx', version '3.11'.
 *
...
Si requiere ayuda, por favor póngase en contacto con {$a->enroller}.';
$string['expirymessageenrolledsubject'] = 'Notificación de expiración de auto-inscripción';
$string['expirymessageenrollerbody'] = 'La auto-inscripción en el curso \'{$a->course}\' expirará dentro de {$a->threshold} para los siguinetes usuarios:
