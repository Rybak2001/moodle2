...
/**
 * Strings for component 'hub', language 'es_mx', version '3.11'.
 *
 * @package     hub
 * @category    string
...
$string['analyticsactionsnotuseful'] = 'Número de acciones que marcan a una predicción como no-útil ({$a})';
...
$string['policyagreeddesc'] = 'Yo estoy de acuerdo con el <a href="{$a}" target="_blank">Aviso de privacidad y acuerdo de procesamiento de datos </a>';
...
$string['registerwithmoodleorginfo'] = '¡Nos encantaría seguir en contacto y proporcionarle cosas importantes para su sitio Moodle! Al registrarse:

* Puede suscribirse para recibir  notificaciones importantes sobre nuevas versiones liberadas de Moodle, alertas de seguridad y otras noticias importantes.
* Puede acceder a, y activar notificaciones push mobile desde su sitio Moodle mediante nuestra App Moodle gratuita.
* Estará contribuyendo a nuestras Estadísticas de Moodle de la comunidad mundial, lo que nos ayuda a mejorar Moodle y nuestros sitios comunitarios.
* Si lo desea, su sitio puede ser incluido en la lista de sitios Moodle registrados en su país';
$string['registerwithmoodleorginfoapp'] = 'Acerca de la app Moodle';
...
$string['registerwithmoodleorgremove'] = 'Usted está a punto de eliminar el registro de su sitio. Ya no recibirá notificaciones de alertas de seguridad importantes y sus usuarios ya no podrán recibir notificaciones push desde su sitio a su app Moodle. ¡Sin embargo, Usted podrá volver a registrarse en cualquier momento! ¿Está seguro de querer continuar?';
...
$string['sendfollowinginfo_help'] = 'La siguiente información será enviada a Moodle cada vez que sea actualizado el registro de su sitio (de forma predeterminada cada semana, cuando el trabajo agendado de \'Registro del sitio\' sea ejecutado). La información contribuye a las estadísticas globales solamente y no será hecho pública en ningún listado del sitio. Adicionalmente, su versión liberada de Moodle es grabada por la comprobación de enlaces de sitio automatizada semanal.';
...
$string['sitecommnews'] = 'Gaceta Moodle';
$string['sitecommnews_help'] = 'Usted tiene la opción de suscribirse a nuestra gaceta Moodle. Usted puede des-suscribirse en cualquier momento.';
$string['sitecommnewsno'] = 'No, no quiero recibir ningún correo';
$string['sitecommnewsyes'] = 'Sí, me gustaría recibir la gaceta Moodle';
...
$string['sitegeolocation'] = 'Geoubicación';
...
$string['siteregistrationemail'] = 'Notificaciones acerca de nuevas versiones liberadas de Moodle, alertas de seguridad y otras noticias importantes.';
$string['siteregistrationemail_help'] = 'Tiene la opción de suscribirse a nuestra lista de correo de bajo volumen para notificaciones de nuevas versiones liberadas de Moodle, alertas de seguridad y otras noticias importantes. Puede des-suscribirse en cualquier momento.';
...
$string['unregisterexplained'] = 'Si el sitio con  URL {$a} es registrado, entonces su registro será eliminado.';
$string['unregisterfrom'] = 'Anular el registro de {$a}';
$string['unregistrationerror'] = 'Se produjo un error al intentar quitar el registro al sitio: {$a}';
...
$string['urlalreadyregistered'] = 'Parece que su sitio ya estaba registrado, lo que significa que algo ha ido mal. Póngase en contacto con el administrador del directorio de sitios para  reiniciar su registro y que  Usted pueda intentarlo otra vez.';
