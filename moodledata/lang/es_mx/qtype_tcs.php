...
/**
 * Strings for component 'qtype_tcs', language 'es_mx', version '3.11'.
 *
 * @package     qtype_tcs
 * @category    string
...
$string['correctansweris'] = 'La respuesta más popular es: {$a}';
...
$string['hypothisistext'] = 'Opción';
$string['hypothisistextdefault'] = 'Opción';
$string['labeleffecttext'] = 'Campo de etiqueta de Nueva información';
...
$string['likertscale2'] = 'Debilitada';
$string['likertscale3'] = 'Sin cambios';
$string['likertscale4'] = 'Reforzada';
