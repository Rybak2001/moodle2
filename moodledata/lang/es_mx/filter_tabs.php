...
/**
 * Strings for component 'filter_tabs', language 'es_mx', version '3.11'.
 *
 * @package     filter_tabs
 * @category    string
...
$string['bootstrapheading'] = 'Bootstrap (Arranque)';
$string['enablebootstrap2'] = 'Habilitar pestañas Bootstrap 2 para usar con temas basados en Bootstrap 2';
$string['enablebootstrap4'] = 'Habilitar pestañas Bootstrap 4 para usar con temas basados en Bootstrap 4';
$string['enableyui'] = 'Habilitar pestañas YUI antiguas';
