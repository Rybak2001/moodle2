...
/**
 * Strings for component 'enrol_guest', language 'es_mx', version '3.11'.
 *
 * @package     enrol_guest
 * @category    string
...
$string['passwordinvalidhint'] = 'La contraseña de acceso es incorrecta, pruebe de nuevo<br /> (Pista - empieza con \'{$a}\')';
...
$string['privacy:metadata'] = 'El plugin de Inscripción para Acceso de Invitado no almacena ningún dato personal.';
