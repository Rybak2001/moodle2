...
/**
 * Strings for component 'learningmap', language 'es_mx', version '3.11'.
 *
 * @package     learningmap
 * @category    string
...
$string['showdescription'] = 'Mostrar mapa en página del curso';
$string['showdescription_help'] = 'Si se activa, el mapa de aprendizaje será mostrado en la página del curso (como una Etiqueta). En caso contrario, habrá un enlace y el mapa será mostrado en una página separada.';
