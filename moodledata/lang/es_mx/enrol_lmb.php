...
/**
 * Strings for component 'enrol_lmb', language 'es_mx', version '3.11'.
 *
 * @package     enrol_lmb
 * @category    string
...
$string['passwordsourcehelp'] = 'Esto determina cual será la contraseña de los usuarios creados
<ul>
<li>Ninguna: No configurar una contraseña interna para Moodle. Use esta opción si Usted está empleando un método de autorización externo, como por ejemplo, LDAP.
<li>useridtype - Login ID: Use el valor proporcionado por el campo de contraseña de la marca userid que está marcada como (ID para ingresar) \'Login ID\'.
<li>useridtype - SCTID: Use el valor proporcionado por el campo de contraseña de la marca userid que está marcada como \'SCTID\'.
<li>useridtype - Email ID: Use el valor proporcionado por el campo de contraseña de la marca userid que está marcada como (ID del Email) \'Email ID\'.
<li>useridtype - Otro: Use el valor proporcionado por el campo de contraseña de la marca userid que está marcada como se indica en la caja de texto.
</ul>';
...
$string['storexmlhelp'] = 'Esto dicta cuando se guardan los mensajes  XML de Luminus Message Broker en la tabla enrol_lmb_raw_xml . Esto permite mayor capacidad de identificar los problemas, pero el XML puede contener datos sensibles (delicados) que no debieran de guardarse. Opciones:
<ul>
<li>Nunca: XML nunca se guardará.
<li>En Error: XML sólamente se guardará si hubiera un error al procesarlo.
<li>Siempre : XML siempre se almacenará.
</ul>';
...
$string['usernamesourcehelp'] = 'Esto determina cual será el nombre_de_usuario de los usuarios creados
<ul>
<li>Dirección Email completa: La dirección completa de Email es usada como nombre_de_usuario .
<li>Nombre del Email (antes del @): Use la porción de la dirección Email que está antes del @.
<li>useridtype - Login ID: Use el valor proporcionado en la marca del userid que está marcada como  \'Login ID\'.
<li>useridtype - SCTID: Use el valor proporcionado en la marca del userid que está marcada como   \'SCTID\'.
<li>useridtype - Email ID: Use el valor proporcionado en la marca del userid que está marcada como   \'Email ID\'.
<li>useridtype - Otro:  Use el valor proporcionado en la marca del userid que está marcada como  está indicado en la caja de texto.
</ul>';
