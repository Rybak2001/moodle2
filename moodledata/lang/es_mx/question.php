...
/**
 * Strings for component 'question', language 'es_mx', version '3.11'.
 *
 * @package     question
 * @category    string
...
$string['privacy:metadata:link:qformat'] = 'El subsistema de Pregunta hace uso del tipo de plugin de Formato para importar/exportar Pregunta para el propósito de importar y exportar preguntas en diferentes formatos.';
