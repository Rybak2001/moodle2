...
/**
 * Strings for component 'enrol_cvent', language 'es_mx', version '3.11'.
 *
 * @package     enrol_cvent
 * @category    string
...
$string['enrol_cvent_mustbeadmin'] = '¡Debe ser Admin o debe correrse desde la interfaz de línea de comando (CLI) !<br />.\\n';
