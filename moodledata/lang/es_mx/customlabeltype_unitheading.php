...
/**
 * Strings for component 'customlabeltype_unitheading', language 'es_mx', version '3.11'.
 *
...
$string['configtypename'] = 'Habilitar subtipo Título de Unidad';
$string['family'] = 'estructura';
$string['heading'] = 'Título de Unidad';
