...
/**
 * Strings for component 'vpl', language 'es_mx', version '3.11'.
 *
 * @package     vpl
 * @category    string
...
$string['depends_on_https'] = 'Usar ws o wss dependiendo de si se usa http o https';
...
$string['runscript_help'] = 'Seleccionar el script de correr para usar en esta actividad';
$string['save'] = 'Guardar';
...
$string['sebkeys_help'] = 'Clave(s) de examen de Navegador de Examen Seguro (máx 3) obtenidas del archivo .seb <br>Esto es más confiable que la mera revisión del navegador.<br>https://safeexambrowser.org';
...
$string['startdate'] = 'Disponible a partir de';
...
$string['vpl:similarity'] = 'Buscar similitud de tareas VPL';
