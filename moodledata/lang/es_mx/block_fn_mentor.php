...
/**
 * Strings for component 'block_fn_mentor', language 'es_mx', version '3.11'.
 *
...
$string['fn_mentor:addinstance'] = 'Añadir un bloque de Gestor de Mentor NED';
$string['fn_mentor:assignmentor'] = 'Asignar entor';
$string['fn_mentor:createnotificationrule'] = 'Crear regla de notificación';
$string['fn_mentor:myaddinstance'] = 'Añadir un bloque de Gestor de Mentor NED a Mi Moodle';
...
<p>Instrucciones:</p>
<ol>
<li>Haga clic en el botón inferior para Exportar Usuarios, para descargar una hoja_de_cálculo con una lista de los usuarios de su sitio.</li>
<li>Abra el archivo con Excel (o con otro programa para hojas_de_cálculo) y haga los cambios deseados.</li>
<li>Importe el archivo al hacer clic en el botón inferior para Importar Usuarios .</li>
</ol>';
...
$string['message_header'] = 'Reporte del Progreso de  <strong>{$a->sitename}</strong> <br />Estudiante:
...
$string['pluginname'] = 'Gestor de Mentor NED';
