...
/**
 * Strings for component 'page', language 'es_mx', version '3.11'.
 *
 * @package     page
 * @category    string
...
$string['createpage'] = 'Crear un recurso de página nueva';
...
$string['modulename_help'] = 'El módulo <b>Página</b> le permite al profesor crear una página web empleando el editor de texto. En una página se pueden mostrar texto, imágenes, sonido, video, enlaces de internet y código incrustado (como los mapas de Google).
...
$string['popupheight'] = 'Altura de las ventanas emergentes (en pixeles)';
$string['popupheightexplain'] = 'Especifica la altura predeterminada de ventanas emergentes.';
$string['popupwidth'] = 'Ancho de las ventanas emergentes (en pixeles)';
$string['popupwidthexplain'] = 'Especifica la anchura por defecto de ventanas emergentes.';
$string['printheading'] = 'Mostrar nombre de página';
$string['printheadingexplain'] = '¿Mostrar nombre de página arriba del contenido ?';
...
$string['printlastmodifiedexplain'] = '¿Mostrar fecha de última modificación debajo de contenido?';
$string['privacy:metadata'] = 'El plugin del recurso de Página no almacena ningún dato personal.';
