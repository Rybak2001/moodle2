...
/**
 * Strings for component 'scorm', language 'es_mx', version '3.11'.
 *
 * @package     scorm
 * @category    string
...
$string['completiondetail:completionstatuscompletedandpassed'] = 'Completar y pasar la actividad';
...
$string['forceattemptoncomplete'] = 'Cuando el intento anterior completó, pasó o reprobó';
...
$string['validationtype'] = 'Esta preferencia ajusta la biblioteca DOMXML usada para validar un Manifiesto SCORM. Si tiene dudas, deje la opción activada.';
$string['value'] = 'Valor';
