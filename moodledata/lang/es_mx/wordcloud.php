...
/**
 * Strings for component 'wordcloud', language 'es_mx', version '3.11'.
 *
 * @package     wordcloud
 * @category    string
...
$string['activityclose'] = 'Elegir la nubedepalabras';
$string['activityopen'] = 'Abrir la nubedepalabras';
$string['activityopenclose'] = 'Fechas de apertura y cierre';
$string['activityopenclose_help'] = 'Los estudiantes solo pueden escribir palabras entre las horas de apertura y cierre.';
