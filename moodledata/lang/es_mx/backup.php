...
/**
 * Strings for component 'backup', language 'es_mx', version '3.11'.
 *
 * @package     backup
 * @category    string
...
$string['asyncmessagebodydefault'] = 'Su {operation} (ID: {backupid}) ha completado exitosamente. Usted puede verla aquí: <a href="{link}">{link}</a>.';
...
$string['asyncrestorecompletedetail'] = 'El proceso de restauración ha completado exitosamente. El seleccionar continuar lo llevará al <a href="{$a}">curso para el elemento restaurado.</a>';
...
$string['copyfieldnotfound'] = 'No se encontraron los datos necesarios para campo(s):  {$a}';
...
$string['errorcopyingbackupfile'] = 'No se pudo copiar el archivo de respaldo a la carpeta temporal antes de restaurar.';
...
$string['importgeneralduplicateadminallowed_desc'] = 'Si el sitio tiene una cuenta con el usuario \'admin\', entonces el intentar restaurar un archivo de respaldo que contenga un usuario \'admin\' puede causar un conflicto. Si se habilita esta configuración, el conflicto será resuelto al cambiar el nombre de usuario en el archivo de respaldo a admin_xyz\'.';
...
$string['pendingasyncedit'] = 'Hay un respaldo pendiente o una copia solicitada para este curso. Por favor no edite este curso hasta después de que esto esté completado.';
...
$string['restorestage32'] = 'Procesar';
...
$string['sitecourseformatwarning'] = 'Este es un respaldo de la portada; Solamente puede ser restaurada restaurarse en la portada';
