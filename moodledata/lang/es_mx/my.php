...
/**
 * Strings for component 'my', language 'es_mx', version '3.11'.
 *
 * @package     my
 * @category    string
...
$string['noguest'] = 'Los invitados no pueden acceder a la página del Tablero';
$string['pinblocks'] = 'Configurar bloques fijados para mi Moodle';
$string['pinblocksexplan'] = 'Los ajustes de bloque que configure aquí serán visibles (y no editables) para cualquier usuario de Moodle en su página general de \'Mi Moodle\'';
$string['privacy:metadata:core_my:preference:user_home_page_preference'] = 'La preferencia de la página inicial del usuario.';
