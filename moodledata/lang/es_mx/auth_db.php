...
$string['auth_dbinsertuserduplicate'] = 'Error al insertar al usuario {$a->username} - un usuario con el mismo nombre de usuario ya había sido creado por el plugin de \'{$a->auth}\'.';
