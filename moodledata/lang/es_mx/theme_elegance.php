...
/**
 * Strings for component 'theme_elegance', language 'es_mx', version '3.11'.
 *
...
$string['bannerimage'] = 'Imagen de presentación';
$string['bannerimagedesc'] = 'Imagen grande para ir detrás del texto de la diapositiva.';
$string['bannerindicator'] = 'Imágen Número {$a}';
...
$string['blocksconfigdesc'] = 'Elija su disposición preferida de bloques';
$string['blocksleft'] = 'Usar bloques izquierdo solamente';
$string['blocksleftandright'] = 'Usar bloques izquierdo y derecho';
$string['blocksright'] = 'Usar bloques derecho solamente';
...
$string['bodybgconfig'] = 'Configurar comportamiento del Cuerpo del Fondo';
$string['bodybgconfigdesc'] = 'Configure el comportamiento preferido del fondo, use imagen pequeña para repetirla, imágenes grandes para completa';
...
$string['bodybgfixed'] = 'Completo, fondo fijo, sin desplazamiento';
$string['bodybgrepeat'] = 'repetir fondo (mosaico)';
$string['bodybgscroll'] = 'Completo, desplazar con contenido';
...
$string['categoryiconinfodesc'] = 'Cada ícono está configurado por ID de categoría ( "category ID") . Usted puede obtener estos al mirar la URL de cada categoría. La lista está  <a href="http://fortawesome.github.io/Font-Awesome/icons/">aquí</a>. Simplemente escriba lo que va después de la "fa-".';
$string['choosereadme'] = '<div class="clearfix">
<div class="well">
<h2>Temwa Elegancia (Elegance)</h2>
<p><img class=img-polaroid src="elegance/pix/screenshot.png" /></p>
<p>Elegancees un tema a 2 columnas, limpio y áltamente personalizable construido a partir de la estructura de Bootstrap 3.</p>
</div></div>';
...
$string['colorsettingssub'] = 'Cambie su aspecto.';
...
$string['enablebannerdesc'] = '¿Usará Usted esta diapositiva?';
...
$string['enableslideshow'] = 'Habilitar carrusel de imágenes';
$string['enableslideshowdesc'] = 'Use para deshabilitar por completo el carrusel de imágenes';
...
$string['fixednavbardesc'] = 'Habilitar Barra de Navegación en la parte superior de la página';
...
$string['fontcolordesc'] = 'Configurar el color perincipal usado en todo el sitio.';
...
$string['headingcolordesc'] = 'Configurar el color usado para la mayoría de los encabezados de todo el sitio.';
...
$string['loginbgnumber'] = 'Número del fondo';
$string['loginbgnumberdesc'] = '¿Cuantos fondos deberían de cambiarse cuando carga la página para ingreso?';
$string['loginimage'] = 'Imagen de Fondo {$a}';
$string['loginimagedesc'] = 'El tamaño ideal para imágenes de fondo es de 1200 por 800 pixeles';
$string['loginsettings'] = 'Pantalla de Ingreso';
...
$string['marketingdesc'] = 'Este tema proporciona la opción de habilitar puntos "publicitarios" o "anuncios" justo debajo del carrusel de imágenes. Estos le permiten fácilmente identificar elementos clave para sus usuarios y proporcionar enlaces directos.';
$string['marketingheading'] = 'Bloque Publicitario {$a}';
...
$string['marketingheightdesc'] = 'Si Usted desea mostrar imágenes en las cajas de Anuncios puede especificar su altura aquí.';
$string['marketingicon'] = 'Ícono';
$string['marketingicondesc'] = 'Nombre del ícono que desea usar. La lista está <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_new">aquí</a>. Simplemente escriba lo que va después de "fa-".';
...
$string['marketingspots'] = 'Bloques Publicitarios';
$string['marketingspotsinrow'] = 'Número de Bloques Publicitarios en hilera';
$string['marketingspotsinrowdesc'] = 'Seleccione el número de bloques publicitarios que desea en una hilera al emplear pantalla completa. Tenga en cuenta que este número será divido entre 2 en dispositivos más pequeños';
$string['marketingspotsnr'] = 'Número de Bloques Publicitarios';
$string['marketingspotsnrdesc'] = 'Seleccione el número de Bloques Publicitarios a mostrar';
...
$string['marketingtitleicondesc'] = 'Nombre del ícono que desea usar para el encabezado de los bloques publicitarios. La lista está <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_new">aquí</a>. Simplemente escriba lo que va después de "fa-".';
$string['marketingurl'] = 'URL Publicitario';
$string['marketingurldesc'] = 'Si se configura, este Bloque Publicitario enlazará a una URL externa';
$string['maxwidth'] = 'Ancho máximo de página';
$string['maxwidthdesc'] = 'Por favor contigure esto a un número razonable entre 850 y 1400 px (pixeles)';
$string['moodlemobilecss'] = 'CSS de Moodle Mobile';
$string['moodlemobilecssdesc'] = 'La aplicación de Moodle Mobile le permite definir una hoja de estilo (\'\'style sheet\'\') externa para estilizar la aplicación. Las reglas CSS que Usted añada a esta área-de-texto se mostrarán en la aplicación Moodle Mobile oficial. Simplemente copie la URL inferior y guárdela en la configuración de "mobilecssurl" debajo de "Web Services -> Mobile".';
...
$string['quicklinkicondesc'] = 'Nombre del ícono que desea usar. La lista está <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_new">aquí</a>. Simplemente escriba lo que va después de "fa-".';
$string['quicklinks'] = 'Enlace rápido Número {$a}';
...
$string['quicklinksheadingdesc'] = 'Escribir las configuraciones para sus Enlaces Rápidos en la Portada.';
...
$string['quicklinksicondesc'] = 'Nombre del ícono que desea usar para el encabezadopara los puntos de Enlaces Rápidos. La lista está <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_new">aquí</a>. Simplemente escriba lo que va después de "fa-".';
$string['quicklinksnumber'] = 'Número de Enlaces';
$string['quicklinksnumberdesc'] = 'Cuantos enlaces rápidos quiere mostrar en la portada.';
...
$string['slidespeeddesc'] = 'Configurar por cuanto tiempo en milisegundos aparece la diapositiva.';
...
$string['socialheadingsub'] = 'Acapare la atención de sus usuarios con Redes Sociales';
$string['socialnetworks'] = 'Redes Sociales';
$string['socioblog'] = 'Lea nuestro Blog';
$string['sociofacebook'] = 'Disfrútenos en Facebook';
$string['socioflickr'] = 'Véanos en Flickr';
$string['sociogoogleplus'] = 'Síganos en Google Plus';
$string['socioinstagram'] = 'Encuéntrenos en Instagram';
$string['sociolinkedin'] = 'Conéctese con nosotros en Linkedln';
$string['sociopinterest'] = 'Véanos en Pinterest';
$string['socioskype'] = 'LLámenos en Skype';
$string['sociotumblr'] = 'Encuéntrenos en Tumblr';
$string['sociotwitter'] = 'Síganos en Twitter';
$string['sociovimeo'] = 'Véanos en Vimeo';
$string['sociovk'] = 'uste de nosotros en VK';
$string['sociowebsite'] = 'Visite nuestro sitio web';
$string['socioyoutube'] = 'Véanos en YouTube';
$string['themecolor'] = 'Color del tema';
$string['themecolordesc'] = 'Configurar su color "resaltado" del tema. Esto se usa también para enlaces.';
$string['togglebanner'] = 'Mostrar Banner';
$string['togglebannerdesc'] = 'Elija si desea mostrar u ocultar el Paso de diapositivas';
$string['togglemarketing'] = 'Vista de Bloque Publicitario';
$string['togglemarketingdesc'] = 'Elija si desea ocltar o mostrar los Bloques Publicitarios.';
$string['togglequicklinks'] = 'Mostrar Enlaces Rápidos';
$string['togglequicklinksdesc'] = 'Elegirsi quiere mostrar o si desea ocultar el área de Enlaces Rápidos.';
...
$string['unreadnewnotification'] = 'Notificación nueva';
