...
/**
 * Strings for component 'customlabeltype_theorema', language 'es_mx', version '3.11'.
 *
...
$string['configtypename'] = 'Habilitar subtipo Teorema';
$string['corollary'] = 'Corolario';
$string['corollary0'] = 'Corolario 1';
$string['corollary1'] = 'Corolario 2';
$string['corollary2'] = 'Corolario 3';
$string['corollary3'] = 'Corolario 4';
$string['corollary4'] = 'Corolario 5';
$string['corollary5'] = 'Corolario 6';
$string['corollary6'] = 'Corolario 7';
