...
/**
 * Strings for component 'editor_tinymce', language 'es_mx', version '3.11'.
 *
...
$string['advanced:blockquote'] = 'Bloquear cita';
$string['advanced:blockquote_desc'] = 'Bloquear Cita';
$string['advanced:bold_desc'] = 'Negrita (Ctrl+B)';
$string['advanced:bullist_desc'] = 'Insertar/remover lista con viñetas';
...
$string['advanced:code_desc'] = 'Editar código fuente HTML';
...
$string['advanced:font_size'] = 'Tamaño letra';
$string['advanced:fontdefault'] = 'Familia Font';
...
$string['advanced:help_shortcut'] = 'Presione ALT-F10 para la barra de herramientas. Presione ALT-0 para ayuda';
...
$string['advanced:indent_desc'] = 'Sangría';
...
$string['advanced:numlist_desc'] = 'Insertar/remover lista numerada';
...
$string['advanced:shortcuts_desc'] = 'Ayuda de accesabilidad';
...
$string['advanced:visualaid_desc'] = 'Mostrar/ocultar elementos línea de guía/invisibles';
$string['advanced_dlg:'] = '';
...
$string['advanced_dlg:about_loaded'] = 'Plugins cargados';
$string['advanced_dlg:about_plugin'] = 'Plugins';
...
$string['advanced_dlg:anchor_invalid'] = 'Por favor especifique un nombre de ancla válido';
$string['advanced_dlg:anchor_name'] = 'Nombre del ancla';
$string['advanced_dlg:anchor_title'] = 'Insertar/editar ancla';
$string['advanced_dlg:charmap_title'] = 'Seleccionar caracter especial';
$string['advanced_dlg:charmap_usage'] = 'Usar flechas izquierda y derecha para navegar.';
...
$string['advanced_dlg:colorpicker_palette_title'] = 'Colores de la paleta';
...
$string['advanced_dlg:link_is_external'] = 'La URL que introdujo parece ser un vínculo externo,  ¿desea agregar el prefijo necesario http:// ?';
...
$string['advimage_dlg:misc'] = 'Misceláneos';
$string['advimage_dlg:missing_alt'] = '¿Esta seguro de querer continuar sin introducir una descripción a la imagen? Sin ella es posible que la imagen no sea accesible para algunos usuarios con discapacidades, o para aquellos que usen navegadores de modo texto, o que naveguen en internet con las imágenes de la página deshabilitadas.';
$string['advimage_dlg:mouseout'] = 'para mouse out';
$string['advimage_dlg:mouseover'] = 'para mouse over';
...
$string['advlink_dlg:encoding'] = 'Codificación de caracteres del destino';
...
$string['advlink_dlg:is_email'] = 'La URL que ha introducido parece ser una direción de correo,  ¿desea agregar el prefijo necesario mailto: ?';
$string['advlink_dlg:is_external'] = 'La URL que ha introducido parece ser un vínculo externo,  ¿desea agregar el prefijo necesario http:// ?';
...
$string['advlink_dlg:mime'] = 'Tipo MIME del destino';
...
$string['advlink_dlg:popup_location'] = 'Mostrar Barra de ubicación';
...
$string['advlink_dlg:popup_statusbar'] = 'Mostrar barra de estatus';
...
$string['advlink_dlg:rel'] = 'Relación página a destino';
$string['advlink_dlg:rev'] = 'Relación destino a página';
...
$string['advlink_dlg:target_langcode'] = 'Idioma del destino';
$string['advlink_dlg:target_name'] = 'Nombre del destino';
$string['advlink_dlg:target_parent'] = 'Abrir en ventana/marco padre';
...
$string['colors:003366'] = 'Azul turquesa oscuro';
$string['colors:008000'] = 'Verde';
$string['colors:008080'] = 'Verde azulado';
$string['colors:00CCFF'] = 'Azul cielo';
$string['colors:00FF00'] = 'Lima';
$string['colors:00FFFF'] = 'Agua';
$string['colors:333300'] = 'Verde aceituna oscuro';
...
$string['colors:800000'] = 'Marrón';
$string['colors:800080'] = 'Morado';
$string['colors:808000'] = 'Aceituna';
$string['colors:808080'] = 'Gris';
$string['colors:993300'] = 'Naranja quemado';
$string['colors:993366'] = 'Café';
$string['colors:999999'] = 'Gris medio';
$string['colors:99CC00'] = 'Verde amarillento';
$string['colors:99CCFF'] = 'Azul cielo claro';
$string['colors:C0C0C0'] = 'Plateado';
$string['colors:CC99FF'] = 'Ciruela';
$string['colors:CCFFCC'] = 'Verde pálido';
$string['colors:CCFFFF'] = 'Cian (azul) pálido';
...
¿Desea obtener más información acerca de este tema?';
$string['common:clipboard_no_support'] = 'Actualmente no está soportado por su navegador, use atajos del teclado como sustituto';
$string['common:close'] = 'Cerrar';
$string['common:edit_confirm'] = '¿Desea utilizar el modo WYSIWYG para esta área-de-texto?';
...
$string['customconfig_desc'] = 'Configuración personalizada avanzada de  TinyMCE en formato JSON; por ejemplo: {"option1" : "value2", "option2" : "value2"}. Cualquier opción especificada aquí anula las configuraciones estándar y del plugin.';
$string['customtoolbar'] = 'Barra de herramientas del editor';
$string['customtoolbar_desc'] = 'Cada linea contiene una lista de nombres de botones separados por coma, use "wrap" como un separador de grupo, las líneas vacías se ignoran. Vea  <a href="{$a}" target="_blank">{$a}</a> para mostrar una lista de los botones estándar de TinyMCE.<br />La primera fila siempre se mostrará, mientras que la visibilidad de la segunda y tercera barra de herramientas puede alternarse';
...
$string['emotions_dlg:yell'] = 'Grito';
$string['fontselectlist'] = 'Lista de tipos de letra (fonts) disponibles';
...
$string['fullpage_dlg:charset'] = 'Juego de caracteres (charset)';
...
$string['fullpage_dlg:defer'] = 'Deferir';
$string['fullpage_dlg:doctypes'] = 'Tipo de doc.';
$string['fullpage_dlg:encoding'] = 'Codificación de caracteres';
$string['fullpage_dlg:font_face'] = 'Cara  del tipo de letra';
$string['fullpage_dlg:font_size'] = 'Tamaño de letra';
$string['fullpage_dlg:fontface'] = 'Familia del tipo de letra (font)';
$string['fullpage_dlg:fontsize'] = 'Tamaño de letra';
$string['fullpage_dlg:general_props'] = 'General';
$string['fullpage_dlg:head_elements'] = 'Elementos de encabezado';
$string['fullpage_dlg:hover_color'] = 'Color ratón encima (hover)';
...
$string['fullpage_dlg:meta_noindex_nofollow'] = 'No indizar y no seguir los enlaces';
...
$string['fullpage_dlg:src'] = 'Orígen';
$string['fullpage_dlg:style'] = 'Estilo';
$string['fullpage_dlg:style_element'] = 'Elemento de Estilo';
...
$string['fullscreen:desc'] = 'Cambiar al modo Pantalla Completa';
$string['iespell:download'] = 'No se detectó \'ieSpell\'.  ¿Desea instalarlo ahora?';
$string['iespell:iespell_desc'] = 'Revisar ortografía';
...
$string['media:desc'] = 'Insertar / editar medio incrustado';
...
$string['media_dlg:altsource2'] = 'Orígen alternativo 1';
...
$string['media_dlg:captioningid'] = 'ID de letrerito (caption)';
...
$string['media_dlg:controller'] = 'Responsable';
$string['media_dlg:controls'] = 'Controles';
$string['media_dlg:correction'] = 'Sin correción';
$string['media_dlg:currentmarker'] = 'Evaluador actual';
...
$string['media_dlg:fullscreen'] = 'Pantallacompleta';
...
$string['media_dlg:imagestatus'] = 'Estatus de imágen';
$string['media_dlg:invokeurls'] = 'Invocar URLs';
$string['media_dlg:kioskmode'] = 'Modo Kiosko';
...
$string['media_dlg:qt_stream_warn'] = 'Los recursos RTSP de Streaming deberían añadirse en el campo QT source (orígen) de la pestaña avanzada.
Además debería añadir una versión no-streaming en el campo orígen.';
$string['media_dlg:qtsrc'] = 'Orígen QT';
$string['media_dlg:qtsrcchokespeed'] = 'Vel. de choque';
$string['media_dlg:quality'] = 'Calidad';
$string['media_dlg:quicktime'] = 'QuickTime';
$string['media_dlg:rate'] = 'Valorar';
...
$string['media_dlg:targetcache'] = 'Caché destino';
$string['media_dlg:title'] = 'Insertar / editar medio incrustado';
...
$string['media_dlg:wmp_options'] = 'Opciones reproductor de Windows Media';
$string['nonbreaking:nonbreaking_desc'] = 'Insertar caracter de espacio \'non-breaking';
$string['pagebreak:desc'] = 'Insertar salto de página para impresión';
$string['paste:paste_text_desc'] = 'Pegar como texto simple';
$string['paste:paste_word_desc'] = 'Pegar desde Word';
$string['paste:plaintext_mode'] = '\'Pegar\' está ahora en modo de texto simple. Haga clic de nuevo para habilitar \'Pegar\' en modo regular. Después de que pegue algo, Usted regresará al modo de texto regular.';
...
$string['simple:bullist_desc'] = 'Insertar/remover lista con viñetas';
$string['simple:cleanup_desc'] = 'Limpiar código basura';
$string['simple:italic_desc'] = 'Cursiva (Ctrl+I)';
$string['simple:numlist_desc'] = 'Insertar/remover lista numerada';
...
$string['spellchecker:desc'] = 'Mostrar/Ocultar corrector ortográfico';
...
$string['spellchecker:menu'] = 'Configuraciones de corrector ortográfico';
...
$string['spellchecker:wait'] = 'Por favor, espere...';
...
$string['style_dlg:box_clear'] = 'Borrar';
...
$string['style_dlg:overflow'] = 'Se desborda';
$string['style_dlg:padding'] = 'Separación';
$string['style_dlg:placement'] = 'Posicionamiento';
...
$string['style_dlg:same'] = 'Lo mismo para todos';
...
$string['style_dlg:text_font'] = 'Tipo de letra (font)';
$string['style_dlg:text_lineheight'] = 'Ancho de la fila';
$string['style_dlg:text_none'] = 'Ninguno(a)';
...
$string['table_dlg:caption'] = 'Letrerito (caption) de la tabla';
$string['table_dlg:cell_all'] = 'Actualizar todas las celdas en la tabla';
$string['table_dlg:cell_cell'] = 'Actualizar celda actual';
$string['table_dlg:cell_col'] = 'Actualizar todas las celdas en la columna';
...
$string['table_dlg:cellpadding'] = 'Separación de celda';
$string['table_dlg:cellspacing'] = 'Espaciado_de_celda';
...
$string['table_dlg:mime'] = 'Tipo MIME objetivo';
$string['table_dlg:missing_scope'] = '¿Está seguro que desea continuar sin especificar el alcance para esta celda de encabezado de tabla? Sin él, podría ser dificultoso para algunos usuarios con discapacidades el entender el contenido o los datos mostrados en la tabla.';
...
$string['table_dlg:rowtype'] = 'Fila en parte de tabla';
...
$string['template_dlg:warning'] = 'Advertencia: Actualizar una plantilla con otra puede causar pérdida de datos.';
$string['visualblocks:desc'] = 'Mostrar/ocultar elementos';
$string['visualchars:desc'] = 'Caracteres de control visual mostrar/ocultar';
...
$string['xhtmlxtras_dlg:fieldset_attrib_tab'] = 'Atributos del elemento';
$string['xhtmlxtras_dlg:fieldset_events_tab'] = 'Eventos del elemento';
$string['xhtmlxtras_dlg:fieldset_general_tab'] = 'Configuraciones generales';
...
$string['xhtmlxtras_dlg:title_cite_element'] = 'Elemento de Cita';
$string['xhtmlxtras_dlg:title_del_element'] = 'Elemento a Borrar';
$string['xhtmlxtras_dlg:title_ins_element'] = 'Elemento a Insertar';
