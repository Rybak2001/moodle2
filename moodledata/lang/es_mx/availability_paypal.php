...
/**
 * Strings for component 'availability_paypal', language 'es_mx', version '3.11'.
 *
...
$string['ajaxerror'] = 'Error al contactar al servidor';
$string['businessemail'] = 'Email de negocios';
$string['continue'] = 'Haga clic aquí para regresar a Moodle';
$string['cost'] = 'Costo';
...
$string['error_itemnumber'] = 'Usted debe proporcionar un número del ítem.';
$string['itemname'] = 'Nombre del ítem';
$string['itemname_help'] = 'Número del ítem a ser mostrado en el formato de PayPal';
$string['itemnumber'] = 'Número del ítem';
