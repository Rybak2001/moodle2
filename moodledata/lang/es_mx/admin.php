...
$string['configallowguestmymoodle'] = 'Si se habilita, los invitados podrán tener acceso al Tablero. De lo contrario se redireccionarán a la Portada.';
...
$string['courserequestnotifyemail'] = 'El usuario {$a->user} solicitó un nuevo curso <a href="{$a->link}">{$a->link}</a>';
...
$string['userfiltersdefault_desc'] = 'Seleccionar los filtros que deberían ser mostrados en la página de \'Mirar lista de usuarios\' y en la página de \'Acciones masivas con usuarios\'. Mantenga oprimida la tecla  Ctrl para seleccionar varios elementos. Cualquier filtro no seleccionado estará disponible al elegir el enlace para \'Mostrar más\'.';
...
$string['xmlrpcmaharaenabled'] = 'Se ha detectado que el ePortafolio de Mahara está habilitado en su sitio. Esta característica depende de la extensión PHP XML-RPC, la cual ya no es mantenida por PHP.';
$string['xmlrpcmnetenabled'] = 'Se ha detectado que la Red Moodle está habilitado en su sitio. Esta característica depende de la extensión PHP XML-RPC, la cual ya no es mantenida por PHP.';
