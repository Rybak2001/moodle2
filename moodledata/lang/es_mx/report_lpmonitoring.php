...
/**
 * Strings for component 'report_lpmonitoring', language 'es_mx', version '3.11'.
 *
...
$string['colorsforscalesaved'] = 'Los colores de la escala {$a} fueron exitosamente guardados.';
...
$string['eventusercompetencyresetted'] = 'Competencia del usuario reconfigurada.';
$string['evidence_reset'] = 'La valoración de la competencia fue restablecida en el plan de aprendizaje \'{$a}\'.';
$string['filter'] = 'Filtrar';
$string['filterboth'] = 'Ambos';
$string['filterby'] = 'Filtrar por';
$string['filterbyscalevalue'] = 'Filtrar por valor de escala';
$string['filtercourse'] = 'En el curso';
$string['filtermodule'] = 'En la actividad del curso';
$string['finalrating'] = 'Valoración final';
$string['finalratingcourse'] = 'Valoración en curso';
$string['finalratingcoursemodule'] = 'Valoración en actividad';
$string['forcerating'] = 'Forzar valoración de usuarios ya valorados';
...
$string['notproficient'] = 'No competente';
$string['notproficientcompetencies'] = 'Competencias no competentes';
...
$string['resetallratings_confirmation'] = 'Esta acción restablecerá las valoraciones de todas las competencias para este plan de aprendizaje. Las valoraciones serán reiniciadas a \'No valorada\' pero las evidencias se mantendrán Esta acción no puede deshacerse. ¿Desea continuar?';
$string['resetallratings_help'] = 'Restablecer todas las competencias de este plan (serán regresadas a \'No valorada\' pero la evidencia será conservada).';
$string['resetonecompetency'] = 'Restablecer esta competencia (será reiniciada a \'No valorada\' pero la evidencia será conservada).';
$string['resetonecompetency_confirmation'] = 'Esta acción restablecerá la valoración para la competencia seleccionada. La valoración será reiniciada a \'No valorada\' pero la evidencia se mantendrá. Esta acción no se puede deshacer. ¿Desea continuar?';
$string['scalefilterby'] = 'Filtrar escala(s) por';
$string['scalesfortemplate'] = 'Escalas para esta plantilla';
...
$string['selectframework'] = 'Elija una estructura de competencia';
...
$string['tags'] = 'Marca(s)';
$string['tagsedit'] = 'Editar marcas';
$string['tagseditshort'] = 'Editar';
$string['taskratingrunning'] = 'La evaluación está en progreso; por favor espere a que termine antes  de iniciar una nueva';
$string['totalnumberrating'] = 'Número total de valoraciones';
