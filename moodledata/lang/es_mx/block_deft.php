...
/**
 * Strings for component 'block_deft', language 'es_mx', version '3.11'.
 *
 * @package     block_deft
 * @category    string
...
$string['bridgedconnection'] = 'Conexiones puenteadas';
...
$string['configuremanually'] = 'El proceso de registro automático ha fallado por alguna razón. La herramienta LTI necesita ser configurada manualmente. Póngase en contacto con los desarrolladores para reportar esto y obtener las URLs para configuración manual.';
...
$string['deft:sharevideo'] = 'Compartir video';
...
$string['enablebridge'] = 'Habilitar puente';
$string['enablebridge_desc'] = 'Esto hace que aparezca la opción para configurar un puente de audio al editar un sitio. El puente permite a más participantes en el sitio y una mejor calidad de audio. Usted también necesitará un plan de  {$a} o otra instalación de servidor para proporcionar el puente.';
...
$string['enablevideo'] = 'Habilitar video';
$string['enablevideo_desc'] = 'Esto hace que el botón para compartir video le aparezca a usuarios con la capacidad para  <em>Compartir video</em>. Usted necesitará un plan de  {$a} o alguna otra configuración del servidor.';
$string['eventaudiobridgelaunched'] = 'Puente de audio invocado';
...
$string['eventvideoended'] = 'Video terminado';
$string['eventvideostarted'] = 'Video iniciado';
...
$string['microphoneon'] = 'El micrófono está activado';
...
$string['peerconnection'] = 'Conexión con pares';
$string['pluginname'] = 'Respuesta ágil';
$string['position'] = 'Posición';
$string['preventresponse'] = 'Prevenir respuesta';
$string['privacy:connections'] = 'Conexiones';
$string['privacy:metadata:block_deft'] = 'Trabajos que fueron modificados por el usuario';
$string['privacy:metadata:block_deft:id'] = 'ID del trabajo';
$string['privacy:metadata:block_deft:timemodified'] = 'Hora de modificación';
$string['privacy:metadata:block_deft:usermodified'] = 'ID del usuario';
$string['privacy:metadata:block_deft_peer'] = 'Datos temporales para estado de la conexión del usuario en el lugar';
$string['privacy:metadata:block_deft_peer:mute'] = 'Si es que está enmudecido';
$string['privacy:metadata:block_deft_peer:status'] = 'Si es que ha terminado';
$string['privacy:metadata:block_deft_peer:task'] = 'ID del trabajo del sitio';
$string['privacy:metadata:block_deft_peer:timecreated'] = 'Hora de creación';
$string['privacy:metadata:block_deft_peer:timemodified'] = 'Hora de modificación';
$string['privacy:metadata:block_deft_peer:type'] = 'Tipo de conexión';
$string['privacy:metadata:block_deft_peer:userid'] = 'ID del usuario';
$string['privacy:metadata:block_deft_peer:uuid'] = 'ID del dispositivo móvil';
...
$string['privacy:metadata:block_deft_room'] = 'Sala del servidor asignada al sitio';
$string['privacy:metadata:block_deft_room:itemid'] = 'ID del trabajo';
$string['privacy:metadata:block_deft_room:timemodified'] = 'Hora de modificación';
$string['privacy:metadata:block_deft_room:usermodified'] = 'ID del usuario';
...
$string['privacy:responses'] = 'Respuestas';
$string['privacy:rooms'] = 'Salas';
$string['privacy:tasks'] = 'Trabajos';
$string['raisehand'] = 'Levantar mano';
$string['reconnecting'] = 'Re-conectando';
...
$string['serverlost'] = 'Conexión al servidor perdida';
$string['sharevideo'] = 'Compartir video';
...
$string['stopvideo'] = 'Detener video';
