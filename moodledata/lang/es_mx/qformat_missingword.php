...
/**
 * Strings for component 'qformat_missingword', language 'es_mx', version '3.11'.
 *
...
$string['beginanswernotfound'] = 'No se pudo encontrar el caracter requerido "{" en el contenido del archivo importado.';
$string['endanswernotfound'] = 'No se pudo encontrar el caracter requerido "}" en el contenido del archivo importado.';
