...
/**
 * Strings for component 'block_myoverview', language 'es_mx', version '3.11'.
 *
...
$string['aria:shortname'] = 'Ordenar cursos por nombre corto del sitio';
...
$string['aria:title'] = 'Ordenar cursos por nombre del curso';
