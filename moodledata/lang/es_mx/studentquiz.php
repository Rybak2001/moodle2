...
$string['privacy:metadata:studentquiz_question:questionid'] = 'ID de la pregunta';
...
$string['privacy:metadata:studentquiz_state_history:questionid'] = 'ID de la pregunta.';
...
$string['settings_allowedrolestoshow_help'] = 'Esto se relaciona con la configuración anterior.No todos los roles en el sistema son relevantes para StudentQuiz, por lo que usted puede usar esta configuración para reducir el número de roles enlistados en el formato de las configuraciones de la actividad. Los roles aquí seleccionados aparecerán en el formato para cada actividad, por   lo el profesor puede cambiar la configuración. Para roles no  seleccionados  aquí, serán excluidos de los reportes dependiendo desi  están excluidos por el  predeterminado de arriba.';
...
$string['settings_privatecommenting_help'] = 'El hilo de discusión privada, accesible al  previsualizar una pregunta hasta que la pregunta sea Aprobada, permite discusión entre el autor de la pregunta y el/los administrador(es) de la actividad. Si el modo de StudentQuiz está configurado a \'Automáticamente publicar nuevas preguntas\', entonces el  autor de la pregunta no necesariamente verá siempre este hilo específico. Sin embargo, permanecerá disponible para el/los administrador(es) de la actividad, los cuales podrían usarlo para explicar el por qué han ocultado o eliminado una  pregunta.|';
