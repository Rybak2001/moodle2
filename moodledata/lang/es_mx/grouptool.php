...
/**
 * Strings for component 'grouptool', language 'es_mx', version '3.11'.
 *
 * @package     grouptool
 * @category    string
...
$string['alwaysshowdescription_help'] = 'Si se deshabilita, la descripción del grouptool de arriba solamente se volverá visible para los estudiantes en la fecha de "Inicio del registro"..';
...
$string['completiondetail:register'] = 'Registrar en grupos: {$a}';
$string['completionregister'] = 'El estudiante debe estar registrado en grupos:';
...
$string['includeonlyactiveenrol_help'] = 'Si se habilita, los usuarios suspendidos no serán incluidos en grupos.';
...
$string['moreregsthanpossible'] = 'Los registros requeridos para finalización no pueden ser mayores de los registros máximos permitidos';
...
$string['require_registration'] = 'Requerir registros';
...
$string['selectfromgroup'] = 'Seleccionar miembros de grupos';
$string['selectfromgroup_help'] = 'Solamente asigne miembros del grupo dado  en los grupos recién creados';
$string['selectfromgrouping'] = 'Seleccionar miembros del agrupamiento';
$string['selectfromgrouping_help'] = 'Solamente asigne miembros del agrupamiento dado  en los grupos recién creados';
...
$string['settingspage'] = 'Editar configuraciones del grupo';
...
$string['unregister_user_from_moodle_group'] = 'Des-registro de <strong>{$a->fullname}</strong> (<strong>{$a->idnumber}</strong>) del grupo Moodle <strong>{$a->groupname}</strong> fue exitoso.';
...
$string['unregister_user_only_in_moodle_group'] = '¡El usuario <strong>{$a->fullname}</strong> solamente está en el grupo Moodle <strong>{$a->groupname}</strong> pero no está en el grupo de grouptool!';
