...
$string['criteria_descr_0'] = 'Completado <strong>{$a}</strong> de los requisitos enlistados.';
...
$string['recipientvalidationproblem'] = 'El usuario actual no puede ser verificado como destinatario de esta insignia.';
