...
/**
 * Strings for component 'qtype_stack', language 'es_mx', version '3.11'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['settingmaximalibraries_desc'] = 'Esta es una lista separada por comas de nombres de biblioteca Maxima que serán automáticamente cargados a Maxima. Solamente pueden ser usados nombres de biblioteca soportados: "stats, distrib, descriptive, simplex". Estas bibliotecas no serán cargadas si Usted ha guardado una imagen Maxima para optimizar el desempeño.';
