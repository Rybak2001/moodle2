...
/**
 * Strings for component 'role', language 'es_mx', version '3.11'.
 *
 * @package     role
 * @category    string
...
$string['contentbank:downloadcontent'] = 'Descargar contenido desde el banco de contenido';
...
$string['contextrolenotallowed'] = 'Rol {$a} no permitido en este contexto.';
...
$string['course:configuredownloadcontent'] = 'Configurar descargar contenidos del curso';
...
$string['course:downloadcoursecontent'] = 'Descargar contenidos del curso';
...
$string['site:senderrormessage'] = 'Enviar un mensaje al usuario de soporte desde la página del error';
