...
/**
 * Strings for component 'availability_gps', language 'es_mx', version '3.11'.
 *
...
$string['privacy:metadata:block_gps_reached:sectionid'] = 'ID de sección';
$string['privacy:metadata:block_gps_reached:userid'] = 'UserID';
$string['reveal'] = 'Revelar posición';
