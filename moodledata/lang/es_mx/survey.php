...
/**
 * Strings for component 'survey', language 'es_mx', version '3.11'.
 *
 * @package     survey
 * @category    string
...
$string['attls11short'] = 'Pensar CON las personas';
$string['attls12'] = 'Tengo un criterio que utilizo para evaluar argumentos.';
$string['attls12short'] = 'Utilice un criterio para evaluar';
$string['attls13'] = 'Prefiero tratar de entender la opinión de alguien más que tratar de evaluarla.';
$string['attls13short'] = 'tratar de entender';
...
$string['attls14short'] = 'Señalar los puntos débiles';
...
$string['attls17short'] = 'Yo valoro la lógica sobre todo';
$string['attls18'] = 'Puedo obtenr intuición sobre opiniones que difieren de la mía a través de la empatía.';
$string['attls18short'] = 'intuición desde empatía';
...
$string['attls3'] = 'Me gusta entender \'de dónde vienen\' los demás, qué experiencias les han hecho sentir de la forma en que lo hacen.';
...
$string['attlsintro'] = 'El propósito de este cuestionario es ayudarnos a evaluar sus actitudes hacia el pensamiento y el aprendizaje. No hay respuestas \'correctas\' o \'equivocadas\', nos interesa sólo su opinión. Sus respuestas serán tratadas con alto grado de confidencialidad y no afectarán su calificación.';
...
$string['cannotfindsurveytmpt'] = '¡ No se encontraron plantillas para encuesta !';
...
$string['colles9'] = 'Explico mis ideas a otros estudiantes.';
...
Cada pareja de las 24 declaraciones siguientes le pedirá que compare su experiencia <strong>preferida</strong> (ideal) y su experiencia <strong>real</strong> en esta unidad.

No hay respuestas "correctas" o "equivocadas"; sólamente nos interesa su opinión. Tenga la certeza de que sus respuestas serán tratadas con alto grado de confidencialidad y no afectarán su evaluación.
...
$string['downloadexcel'] = 'Descargar datos como hoja de cálculo Excel';
$string['downloadinfo'] = 'Puede descargar los datos crudos completos en formato compatible con Excel, SPSS o algún otro programa.';
$string['downloadresults'] = 'Descargar resultados';
$string['downloadtext'] = 'Descargar como texto';
$string['editingasurvey'] = 'Editando una encuesta';
$string['errorunabletosavenotes'] = 'Ocurrió un error al guardar sus notas.';
$string['eventreportdownloaded'] = 'Reporte de encuesta descargado';
$string['eventreportviewed'] = 'Reporte de encuesta visto';
$string['eventresponsesubmitted'] = 'Reporte de encuesta enviado';
$string['guestsnotallowed'] = 'Solamente los usuarios inscritos pueden participar en las encuestas';
...
$string['modulename'] = 'Encuesta predefinida';
...
$string['page-mod-survey-x'] = 'Cualquier página del módulo Encuesta predefinida';
$string['peoplecompleted'] = '{$a} personas han completado esta encuesta hasta ahora';
...
$string['privacy:metadata:analysis'] = 'Un registro del análisis de encuesta.';
$string['privacy:metadata:analysis:notes'] = 'Notas guardadas contra las respuestas de un usuario.';
$string['privacy:metadata:analysis:userid'] = 'La ID del usuario que contesta la encuesta.';
...
$string['privacy:metadata:answers:answer2'] = 'Campo adicional para guardar la respuesta a una pregunta.';
$string['privacy:metadata:answers:question'] = 'La pregunta.';
$string['privacy:metadata:answers:time'] = 'La hora a la que se publicó la respuesta.';
$string['privacy:metadata:answers:userid'] = 'La ID del usuario que envió la respuesta.';
$string['question'] = 'Pregunta';
$string['questions'] = 'Preguntas';
$string['questionsnotanswered'] = 'Algunas de las preguntas con opción múltiple no han sido contestadas.';
$string['report'] = 'Reporte de la encuesta';
$string['responsereports'] = 'Reportes de respuesta';
$string['responses'] = 'Respuestas';
$string['savednotes'] = 'Sus notas se han guardado';
$string['scaleagree5'] = 'totalmente en desacuerdo, un poco en desacuerdo, ni de acuerdo ni en desacuerdo, un poco de acuerdo, totalmente de acuerdo';
$string['scales'] = 'Escalas';
$string['scaletimes5'] = 'Casi nunca, Rara vez, Alguna vez, A menudo, Casi siempre';
$string['search:activity'] = 'Encuesta predefinida - información de actividad';
...
$string['survey:addinstance'] = 'Añadir una nueva encuesta predefinida';
...
$string['surveycompletednograph'] = 'Usted ha completado esta encuesta.';
...
$string['surveytype_help'] = '<p>Hay disponibles tres tipos de Encuestas predefinidas diferentes:</p>
<p>* ATTLS - Attitudes to thinking and Learning Survey, o lo que es lo mismo, Actitudes de pensamiento y aprendizaje. Sirve para medir el grado en el que un alumno es un "conocedor conectado" (tiende a disfrutar más del aprendizaje, es más colaborativo y está dispuesto a aprender de las ideas de los demás), o bien un "conocedor desconectado" (tiende a tomar una actitud de aprendizaje más
